...
const UpdateProfile = () => {
  ...
  const handleProfileSubmit = async (e) => {
    ...
    // Standardize names to CamelCase before sending
    const formattedData = {
      ...formData,
      firstName: camelCaseName(formData.firstName),
      lastName: camelCaseName(formData.lastName),
      companyName: camelCaseName(formData.companyName)
    };
    try {
    ...
    <div className="min-h-screen bg-[#fcfaf9] selection:bg-[#4c8051]/20 font-sans antialiased text-[#496279] overflow-x-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 pt-32 pb-32 sm:pb-24 max-w-7xl">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12">
          <Breadcrumb />
          <Link to={user?.role === 'company' ? '/dashboard/company' : '/dashboard/employee'} className="group flex items-center gap-4 text-xs font-black tracking-[0.3em] text-slate-400 hover:text-[#496279] transition-all">
        ...
        <div className="grid lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            {[
              ...
              >
                ...
                <span className="text-xs font-black tracking-[0.3em] uppercase">{tab.label}</span>
              </button>
            ))}
            ...
            <div className="mt-12 p-10 bg-[#dd8d88]/5 border border-[#dd8d88]/10 rounded-[3rem] text-center group">
              ...
              <h4 className="text-xs font-black text-[#dd8d88] tracking-widest mb-2">Important Notice</h4>
              <p className="text-[11px] font-bold text-[#dd8d88]/50 normal-case leading-relaxed">Changes to your name or designation might need verification from our team.</p>
            </div>
          </div>
          ...
          <div className="lg:col-span-3">
            <div className="bg-white border border-slate-100 rounded-[4rem] p-10 md:p-16 shadow-sm hover:shadow-2xl transition-all duration-700 relative overflow-hidden group">
                ...
                <form onSubmit={handleProfileSubmit} className="space-y-12 animate-in fade-in slide-in-from-right-8 duration-700">
                  <div className="flex items-center gap-10 border-b border-slate-50 pb-12">
                    <div className="h-32 w-32 bg-slate-50 rounded-[3rem] border border-slate-100 flex items-center justify-center text-4xl font-black text-[#496279] shadow-inner relative group/avatar">
                      ...
                      <button type="button" className="absolute inset-0 bg-[#496279]/80 text-white rounded-[3rem] opacity-0 group-hover/avatar:opacity-100 transition-all flex items-center justify-center text-[11px] font-black tracking-widest uppercase">Update Photo</button>
                    </div>
                    <div className="space-y-2">
                      <h3 className="text-2xl font-black tracking-tighter">Profile Picture</h3>
                      <p className="text-xs font-bold text-slate-300 tracking-[0.2em] normal-case">How you'll appear on the network.</p>
                    </div>
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                    {user?.role === 'employee' ? (
                      <>
                        <div className="space-y-3">
                          <label className="text-xs font-black tracking-[0.3em] text-slate-200 ml-4">First Name</label>
                        ...
                        <div className="space-y-3">
                          <label className="text-xs font-black tracking-[0.3em] text-slate-200 ml-4">Last Name</label>
                        ...
                        <div className="md:col-span-2 space-y-3">
                          <label className="text-xs font-black tracking-[0.3em] text-slate-200 ml-4">Designation</label>
                      ...
                      <div className="md:col-span-2 space-y-3">
                        <label className="text-xs font-black tracking-[0.3em] text-slate-200 ml-4">Company Name</label>
                    ...
                    <div className="space-y-3">
                      <label className="text-xs font-black tracking-[0.3em] text-slate-200 ml-4">Email Address</label>
                    ...
                    <div className="space-y-3">
                      <label className="text-xs font-black tracking-[0.3em] text-slate-200 ml-4">Phone Number</label>
                    ...
                    <div className="md:col-span-2 space-y-3">
                      <label className="text-xs font-black tracking-[0.3em] text-slate-200 ml-4">Bio / Summary</label>
              ...
              {activeTab === 'security' && (
                user?.role === 'employee' ? (
                  <div className="p-10 bg-[#496279] rounded-[3rem] text-white shadow-2xl relative overflow-hidden text-center">
                    ...
                    <p className="text-[11px] font-bold text-white/60 tracking-widest normal-case leading-relaxed">Password change is disabled for employees. Please use your First Name and Date of Birth to login.</p>
                  </div>
                ) : (
                  <form onSubmit={handleSecuritySubmit} className="space-y-12 animate-in fade-in slide-in-from-right-8 duration-700">
                    <div className="p-10 bg-[#496279] rounded-[3rem] text-white shadow-2xl relative overflow-hidden">
                      <div className="absolute top-0 right-0 w-32 h-32 bg-[#4c8051] opacity-20 rounded-full blur-[40px] -mr-16 -mt-16"></div>
                      <h3 className="text-xl font-black tracking-tighter mb-4"><i className="fas fa-lock mr-4"></i>Change Password</h3>
                      <p className="text-xs font-bold text-white/40 tracking-widest normal-case leading-relaxed">Updating your password helps keep your account secure.</p>
                    </div>
                    <div className="space-y-8">
                      <div className="space-y-3">
                        <label className="text-xs font-black tracking-[0.3em] text-slate-200 ml-4">Current Password</label>
                      ...
                      <div className="grid md:grid-cols-2 gap-8">
                        <div className="space-y-3">
                          <label className="text-xs font-black tracking-[0.3em] text-slate-200 ml-4">New Password</label>
                        ...
                        <div className="space-y-3">
                          <label className="text-xs font-black tracking-[0.3em] text-slate-200 ml-4">Confirm New Password</label>
                      ...
                      <div key={pref.id} className="bg-slate-50 border border-slate-100 rounded-[2.5rem] p-10 flex items-center justify-between group/pref hover:border-[#496279]/30 transition-all">
                        <div className="flex items-center gap-8">
                          ...
                          <div>
                            ...
                            <p className="text-xs font-bold text-slate-300 normal-case">{pref.desc}</p>
                          </div>
                        </div>
                        <div
