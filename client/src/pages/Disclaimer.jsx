      ...
      <div className="container mx-auto px-4 sm:px-6 pt-32 pb-28 sm:pb-20 max-w-4xl">
        <div className="bg-white border border-slate-100 rounded-[3.5rem] shadow-2xl p-10 md:p-16 relative overflow-hidden animate-on-scroll">
          ...
          <div className="flex items-center gap-4 mb-12">
            ...
            <div>
              <h1 className="text-3xl font-black text-[#496279] tracking-tighter leading-none">Disclaimer.</h1>
              <p className="text-xs font-black text-slate-400 tracking-[0.3em] mt-2">Legal Notice ID: HS-DISCLAIMER-2026</p>
            </div>
          </div>
          ...
          <div className="mt-16 pt-12 border-t border-slate-50 flex flex-col items-center">
            ...
            <p className="text-xs font-black text-slate-300 tracking-[0.5em]">HireShield Legal Policy</p>
          </div>
        </div>
